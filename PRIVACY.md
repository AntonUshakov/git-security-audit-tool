...
**GitHub API only.** This tool calls `api.github.com` directly using the
token you provide, and nothing else. There is no other third-party
integration in this codebase - no optional API keys, no other services to
configure.

- All core features work offline after the GitHub API calls complete
- No tracking pixels
- No external CDNs
