...
<ol>
    <li>Go to <a href="https://github.com/settings/tokens" target="_blank">GitHub Settings → Developer settings → Tokens</a></li>
    <li>Click "Generate new token (classic)"</li>
    <li>Give it a name like "Security Auditor"</li>
    <li>Select these scopes:
        <ul>
            <li><code>repo</code> - Full control of private repositories</li>
            <li><code>admin:org_hook</code> - Full control of organization hooks</li>
            <li><code>read:org</code> - Read-only access to organization data</li>
            <li><code>audit_log</code> - Access audit logs (if available)</li>
        </ul>
    </li>
...
<div class="control-box">
    ...
    <p>Absolutely! Download the HTML or JSON reports and share them. Keep the PDF for formal compliance documentation.</p>
</div>
...
<div class="control-box">
    ...
    <ul>
        <li><strong>Token permissions:</strong> Token needs <code>admin:org_hook</code> and <code>read:org</code> scopes</li>
        <li><strong>User role:</strong> You must be an organization owner to access certain settings</li>
        <li><strong>Plan limitations:</strong> Feature unavailable on your GitHub plan</li>
    </ul>
    <p>Check the error message in the report for details.</p>
</div>
